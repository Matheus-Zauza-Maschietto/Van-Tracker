...
class EditarEnderecoWidget extends StatefulWidget {
  Endereco? endereco;

  EditarEnderecoWidget({Key? key}) : super(key: key);
  EditarEnderecoWidget.editar({Key? key, this.endereco}) : super(key: key);


  @override
  State<StatefulWidget> createState() => EditarEnderecoWidgetState(enderecoEditavel: endereco);
}

class EditarEnderecoWidgetState extends State<EditarEnderecoWidget> {
  ...
  int? municipioEditavelId;
  int? estadoEditavelId;

  EditarEnderecoWidgetState({this.enderecoEditavel}) {
    bairroController.text = enderecoEditavel!.bairro!;
    ruaController.text = enderecoEditavel!.rua!;
    numeroController.text = enderecoEditavel!.numero!;
    complementoController.text = enderecoEditavel!.complemento!;
    cepController.text = enderecoEditavel!.cep!;
  }
